...
<div align="center">
  ...
  <p align="center">
    An E-commerce Website built using React and Node.js
  </p>
</div>
...
_Below is an example of how you can install and run our project

1. Clone the repo
   ```sh
   git clone https://github.com/AhmedAb1d/E-commerce.git
   ```
